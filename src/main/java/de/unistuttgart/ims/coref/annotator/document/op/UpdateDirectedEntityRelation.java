...
public class UpdateDirectedEntityRelation extends UpdateOperation<DirectedEntityRelation> implements RelationModelOperation {
	...
	public UpdateDirectedEntityRelation(DirectedEntityRelation relation, EntityRelationProperty property, Object newValue) {
		super(relation);
