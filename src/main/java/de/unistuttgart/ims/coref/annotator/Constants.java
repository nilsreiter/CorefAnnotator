...
public class Constants {
	...
	public static class Strings {
		...
		public static final String ACTION_FILE_CONNECT = "action.connect_files";
		public static final String ACTION_FILE_CONNECT_TOOLTIP = "action.connect_files.tooltip";
