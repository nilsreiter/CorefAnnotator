...
public class UpdateEntityRelation extends UpdateOperation<EntityRelation> implements RelationModelOperation {
	...
	public UpdateEntityRelation(EntityRelation relation, EntityRelationProperty property, Object newValue) {
		super(relation);
