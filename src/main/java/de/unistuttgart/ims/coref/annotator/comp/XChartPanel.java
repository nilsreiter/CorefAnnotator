 ...
 * the chart as PNG, JPEG, etc. file.
 *
 * @author timmolter
 */
public class XChartPanel<T extends Chart> extends JPanel {
			...
			if (fileChooser.getSelectedFile() != null) {
				...
				try {
					if (fileChooser.getFileFilter() == null) {
						...
						BitmapEncoder.saveJPGWithQuality(chart,
						...
						VectorGraphicsEncoder.saveVectorGraphic(chart, theFileToSave.getCanonicalPath(),
	...
	private class SuffixSaveFilter extends FileFilter {
		...
		/**
		 * @param suffix This file filter accepts all files that end with .suffix or the
		 *               capitalized suffix.
		 */
