...
public class SetAnnotatorNameAction extends IkonAction {
	...
	public SetAnnotatorNameAction(Annotator mApp) {
		super(Strings.ACTION_SET_ANNOTATOR_NAME, MaterialDesign.MDI_ACCOUNT_CARD_DETAILS);
	}
	...
	public void actionPerformed(ActionEvent e) {
		...
		String s = JOptionPane
				.showInputDialog(Annotator.getString(Strings.DIALOG_CHANGE_ANNOTATOR_NAME_PROMPT), current);
		if (s != null && s != current)
